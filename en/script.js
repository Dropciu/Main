...
if(!(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) && window.innerWidth > 750){
    ...
    hover_title.innerHTML = "<p>Click to save the email in the clipboard</p>";
    ...
    document.getElementById("email").addEventListener("click", function(){
        ...
        announcement.innerHTML = "<p>Save the email in the clipboard!</p>";
...
window.onload = (event) => {
    ...
    setInterval(() => {
        ...
        setTimeout(() => {
            ...
            document.title = "Kacper Drobik- Programmer and race walker";

        }, 2500);

        setTimeout(() => {

            document.title = "Kacper Drobik- Projects and achievements";
